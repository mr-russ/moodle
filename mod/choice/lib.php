 ...
 * @since Moodle 3.2
 */
function choice_check_updates_since($choice, $cm, $context, $from, $filter = array()) {
    global $DB;

    $updates = new stdClass();
    if (!has_capability('mod/choice:view', $context)) {
        return $updates;
    }
    ...
    $updates = course_check_module_updates_since($choice, $cm, $context, $from, array(), $filter);
