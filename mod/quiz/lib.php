 ...
 * @since Moodle 3.2
 */
function quiz_check_updates_since($quiz, $cm, $context, $from, $filter = array()) {
    global $DB, $USER, $CFG;
    require_once($CFG->dirroot . '/mod/quiz/locallib.php');
    ...
    $updates = course_check_module_updates_since($quiz, $cm, $context, $from, array(), $filter);
    ...
    $params = array($quiz->id, $USER->id, $from);
