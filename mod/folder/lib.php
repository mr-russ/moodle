 ...
 * @since Moodle 3.2
 */
function folder_check_updates_since($folder, $cm, $context, $from, $filter = array()) {

    $updates = new stdClass();
    if (!has_capability('mod/folder:view', $context)) {
        return $updates;
    }
    $updates = course_check_module_updates_since($folder, $cm, $context, $from, array('content'), $filter);
